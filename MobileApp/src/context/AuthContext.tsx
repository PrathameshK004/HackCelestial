...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
            ...
            .then((res) => {
              ...
              if (freshUser && (freshUser.id || freshUser.userId)) {
                const merged: User = { 
                  ...
                  avatar: freshUser.avatar !== undefined ? String(freshUser.avatar || '').trim() || null : savedUser.avatar,
  ...
  const persistSession = async (data: any, fallbackName?: string, fallbackEmail?: string) => {
    ...
    const resolvedUser: User = data.user || {
      ...
      avatar: String(data.avatar || data.user?.avatar || '').trim() || null,
    ...
    try {
      ...
      if (freshUser && (freshUser.id || freshUser.userId)) {
        const merged: User = {
          ...
          avatar: freshUser.avatar !== undefined ? String(freshUser.avatar || '').trim() || null : user?.avatar,
    ...
    try {
      ...
      if (serverUser && (serverUser.id || serverUser.userId)) {
        const merged: User = {
          ...
          avatar: serverUser.avatar !== undefined ? String(serverUser.avatar || '').trim() || null : (data.avatar !== undefined ? String(data.avatar || '').trim() || null : user.avatar),
