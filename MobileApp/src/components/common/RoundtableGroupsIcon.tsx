/**
 * RoundtableGroupsIcon for React Native
 * 100% exact replica of WebApp/src/components/common/RoundtableGroupsIcon.tsx
 */
...
export const RoundtableGroupsIcon: React.FC<RoundtableGroupsIconProps> = ({
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 100 100">
      ...
      {/* 2. LEFT PERSON */}
      {/* Head */}
      <Circle cx="21" cy="30.5" r="8" fill={color} />
      {/* Chair Backrest */}
      <Path
      ...
      {/* 3. RIGHT PERSON */}
      {/* Head */}
      <Circle cx="79" cy="30.5" r="8" fill={color} />
      {/* Chair Backrest */}
      <Path
      ...
      {/* Head */}
      <Circle cx="50" cy="51.5" r="10" fill={color} />
      {/* Shoulders */}
      <Path
