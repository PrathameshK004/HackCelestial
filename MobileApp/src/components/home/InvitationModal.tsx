/**
 * Official Trip Invitation Screen Modal
...
export const InvitationModal: React.FC<InvitationModalProps> = ({
  ...
  }, [visible, inviteCode, initialDetails]);
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            setActionError(null);
            try {
              const res = await groupService.rejectInvite(code);
    ...
    <Modal visible={visible} animationType="slide" transparent={false} onRequestClose={onClose}>
      <View style={styles.safeContainer}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Trip Invitation</Text>
          <View style={{ width: 36 }} />
        </View>
        ...
        {isLoading ? (
          <View style={styles.loadingContainer}>
            <View style={styles.loadingIconBox}>
              <Compass size={32} color={colors.primary600} strokeWidth={2.2} />
            </View>
            ...
            <ActivityIndicator size="small" color={colors.primary600} style={{ marginTop: 14 }} />
          </View>
        ) : actionError && !details ? (
              ...
              {decisionState === 'ACCEPTED' ? (
                <View style={styles.decisionBannerAccepted}>
                  ...
                  <TouchableOpacity
                    ...
                    activeOpacity={0.85}
                  >
                    <Text style={styles.workspaceBtnText}>Enter Trip</Text>
                  ...
                  >
                    {isProcessing ? (
                      ...
                      <>
                        ...
                        <Text style={styles.acceptBtnText}>Accept & Join Trip</Text>
                      </>
                    )}
                  </TouchableOpacity>
